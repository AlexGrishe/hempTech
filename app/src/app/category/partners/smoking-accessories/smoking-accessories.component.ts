...
@Component({
  selector: 'app-smoking-accessories',
  templateUrl: './smoking-accessories.component.html',
  styleUrls: ['./smoking-accessories.component.scss']
})
export class SmokingAccessoriesComponent implements OnInit {
  product: any;
  products = products;
