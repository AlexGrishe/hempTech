...
@Component({
  selector: 'app-faintly-smelling',
  templateUrl: './faintly-smelling.component.html',
  styleUrls: ['./faintly-smelling.component.scss']
})
export class FaintlySmellingComponent implements OnInit {
  product: any;
  products = products;
