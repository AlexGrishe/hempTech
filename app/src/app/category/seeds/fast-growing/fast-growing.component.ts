...
@Component({
  selector: 'app-fast-growing',
  templateUrl: './fast-growing.component.html',
  styleUrls: ['./fast-growing.component.scss']
})
export class FastGrowingComponent implements OnInit {
  product: any;
  products = products;
