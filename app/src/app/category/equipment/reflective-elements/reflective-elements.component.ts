...
@Component({
  selector: 'app-reflective-elements',
  templateUrl: './reflective-elements.component.html',
  styleUrls: ['./reflective-elements.component.scss']
})
export class ReflectiveElementsComponent implements OnInit {
  product: any;
  products = products;
